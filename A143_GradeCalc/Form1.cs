...
namespace A143_GradeCalc
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            int[] arrCreadit = { 1, 2, 3, 4, 5 };
            List<String> lstGreade = new List<string> { "A+", "A0", "B+", "B0", "C+", "C0", "D+", "D0", "F" };

            foreach (var combo in crds)
            {
                foreach (var i in arrCreadit)
                {
                    combo.Items.Add(1);
                }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            txtGreade.Text = (totalScore / totalCreadits).ToString("0.00");
        }
